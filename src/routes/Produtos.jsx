...
export default function Home() {
  ...
  useEffect(()=>{
    console.log("Este useEffet renderiza sempre que houver uma atualização neste componente ou em um elemento filho");
  });
  ...
  //Estrutura de declaração do useEffect que executa sempre baseado em um determinado elemento. Este elemento pode ser:
        ...
        useEffect(()=>{
          console.log("Este useEffect renderiza renderiza apenas quando o objeto monitorado sofre atualização.");
        },[counter2]);
